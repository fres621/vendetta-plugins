    ...
    return (
        ...
        >
            <ConnectedKeyboardAwareView>
                ...
                >
                    <Text variant="heading-lg/extrabold" style={{ textAlign: "center" }}>
                        {i18n.Messages.CATEGORY_NAME_PLACEHOLDER}
                    </Text>
                    <InputView
                        value=""
                        error={error}
                        ...
                        placeholderTextColor={resolveSemanticColor(
                            ThemeStore.theme,
                            semanticColors.INPUT_PLACEHOLDER_TEXT,
                        )}
                    ...
                    <View style={{ marginTop: 24 }}>
                        <Button text={"Save"} color="brand" look={Button.Looks.FILLED} onPress={onSave} />
                        <Button text={"Cancel"} look={Button.Looks.OUTLINED} style={{ marginTop: 8 }} onPress={close} />
                    </View>
                </View>
            </ConnectedKeyboardAwareView>
        </View>
