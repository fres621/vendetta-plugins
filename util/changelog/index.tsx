...
const getModal = (changelog: Changelog, title?: string) =>
    function () {
            ...
            <Navigator
                ...
                screens={{
                    CHANGELOG: {
                        ...
                        render: function () {
                            return Object.entries(changelog.versions)
                                                ...
                                                {(
                                                    [
                                                        ...
                                                        [
                                                            "=",
                                                            use.CHANGED,
                                                            <FormIcon source={getAssetIDByName("ic_more_24px")} />,
                                                        ],
                                                    ...
                                                    return entry[sign].length ? (
                                                        <>
                                                            ...
                                                            />
                                                            {entry[sign].map((line) => (
                                                                <FormText style={{ marginLeft: 56, lineHeight: 32 }}>
                                                                    {line}
                                                                </FormText>
                                                            ))}
                                                        </>
